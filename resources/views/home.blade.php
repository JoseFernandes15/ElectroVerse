...
@section('content')
              ...
              <div class="row d-flex flex-wrap align-items-center">
                <div class="col-md-6">
                  <div class="banner-content">
                    ...
                    <a href="shop.html" class="btn btn-medium btn-dark text-uppercase btn-rounded-none hover_style">{{ __('home.btn_shop') }}</a>
                  </div>
                </div>
                <div class="col-md-5">
            ...
            @foreach ($populares as $popular)
              <div class="swiper-slide">
                <div class="product-card position-relative">
                  <div class="image-holder">
                    <img src="{{ $popular->image }}" alt="product-item" class="img-fluid" style="width: 310px !important; height: 350px !important;">
                  </div>
                  ...
                  <div class="card-detail d-flex justify-content-between align-items-baseline pt-3">
                    <h3 class="card-title text-uppercase">
                      <a href="{{ route('product', $popular->id) }}">{{ $popular->name }}</a>
                    </h3>
                    <span class="item-price text-primary">{{ $popular->price }}€</span>
                  </div>
                </div>
              </div>
              @endforeach
            ...
            <div class="swiper-wrapper">
              @foreach ($accessories as $accessorie)
                <div class="swiper-slide">
                  <div class="product-card position-relative">
                    <div class="image-holder">
                      <img src="{{ $accessorie->image }}" alt="product-item" class="img-fluid" style="width: 310px !important; height: 350px !important;">
                    </div>
                    <div class="cart-concern position-absolute">
                      <div class="cart-button d-flex">
                        <a href="#" class="btn btn-medium btn-black">{{ __('home.add') }}<svg class="cart-outline"><use xlink:href="#cart-outline"></use></svg></a>
                    ...
                    <div class="card-detail d-flex justify-content-between align-items-baseline pt-3">
                      <h3 class="card-title text-uppercase">
                        <a href="{{ route('product', $popular->id) }}">{{ $accessorie->name }}</a>
                      </h3>
                      <span class="item-price text-primary">{{ $accessorie->price }}€</span>
                    </div>
                  </div>
                </div>
                @endforeach
    ...
    <section id="yearly-sale" class="bg-light-blue overflow-hidden mt-5 padding-xlarge" style="background-image: url('storage/images/single-image1.png');background-position: right; background-repeat: no-repeat;">
      <div class="row d-flex flex-wrap align-items-center">
        <div class="col-md-6 col-sm-12">
          <div class="text-content offset-4 padding-medium">
            <h3>10% {{ __('home.sale') }}</h3>
            <h2 class="display-2 pb-5 text-uppercase text-dark">{{ __('home.sale_name') }}</h2>
            <a href="shop.html" class="btn btn-medium btn-dark text-uppercase btn-rounded-none hover_style">{{ __('home.sale_btn') }}</a>
          </div>
        </div>
        <div class="col-md-6 col-sm-12">
        ...
        <div class="row">
          ...
          <div class="post-grid d-flex flex-wrap justify-content-between">
            <div class="col-lg-4 col-sm-12">
              <div class="card border-none me-3">
                <div class="card-image">
                  <img src="storage/images/post-item1.jpg" alt="" class="img-fluid">
                </div>
              </div>
            ...
            <div class="col-lg-4 col-sm-12">
              <div class="card border-none me-3">
                <div class="card-image">
                  <img src="storage/images/post-item2.jpg" alt="" class="img-fluid">
                </div>
              </div>
              <div class="card-body text-uppercase">
                <div class="card-meta text-muted">
            ...
            <div class="col-lg-4 col-sm-12">
              <div class="card border-none me-3">
                <div class="card-image">
                  <img src="storage/images/post-item3.jpg" alt="" class="img-fluid">
                </div>
              </div>
              <div class="card-body text-uppercase">
                <div class="card-meta text-muted">
          ...
          <div class="d-flex flex-wrap">
            <figure class="instagram-item pe-2">
              <a href="https://templatesjungle.com/" class="image-link position-relative">
                <img src="storage/images/insta-item1.jpg" alt="instagram" class="insta-image">
            ...
            <figure class="instagram-item pe-2">
              <a href="https://templatesjungle.com/" class="image-link position-relative">
                <img src="storage/images/insta-item2.jpg" alt="instagram" class="insta-image">
                <div class="icon-overlay position-absolute d-flex justify-content-center">
                  <svg class="instagram">
                    <use xlink:href="#instagram"></use>
                  </svg>
            ...
            <figure class="instagram-item pe-2">
              <a href="https://templatesjungle.com/" class="image-link position-relative">
                <img src="storage/images/insta-item3.jpg" alt="instagram" class="insta-image">
                <div class="icon-overlay position-absolute d-flex justify-content-center">
                  <svg class="instagram">
                    <use xlink:href="#instagram"></use>
                  </svg>
            ...
            <figure class="instagram-item pe-2">
              <a href="https://templatesjungle.com/" class="image-link position-relative">
                <img src="storage/images/insta-item4.jpg" alt="instagram" class="insta-image">
                <div class="icon-overlay position-absolute d-flex justify-content-center">
                  <svg class="instagram">
                    <use xlink:href="#instagram"></use>
                  </svg>
            ...
            <figure class="instagram-item pe-2">
              <a href="https://templatesjungle.com/" class="image-link position-relative">
                <img src="storage/images/insta-item5.jpg" alt="instagram" class="insta-image">
                <div class="icon-overlay position-absolute d-flex justify-content-center">
                  <svg class="instagram">
                    <use xlink:href="#instagram"></use>
                  </svg>
